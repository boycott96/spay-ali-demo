...
import top.videoboy.common.R;
import top.videoboy.pay.entity.AliPayBean;
import top.videoboy.utils.CodeUtil;
...
//                    .setAliPayRootCertPath(aliPayBean.getAliPayRootCertPath())
    ...
    public R<String> appPay() {
        try {
            ...
            return R.error("system error:" + e.getMessage());
        }
    }
    ...
    public void wapPay(HttpServletResponse response) {
        ...
        String outTradeNo = CodeUtil.getOutTradeNo();
...
//        String notifyUrl = aliPayBean.getDomain() + NOTIFY_URL;
    ...
    /**
     * 单笔转账到支付宝账户
     * <a href="https://docs.open.alipay.com/309/106235/">...</a>
     */
    ...
    public String transfer() {
        ...
        model.setOutBizNo(CodeUtil.getOutTradeNo());
    ...
    public AlipayFundAuthOrderFreezeResponse authOrderFreeze(@RequestParam("auth_code") String authCode) {
        try {
            ...
            model.setOutOrderNo(CodeUtil.getOutTradeNo());
            model.setOutRequestNo(CodeUtil.getOutTradeNo());
            model.setAuthCode(authCode);
    ...
    /**
     * 红包协议支付接口
     * <a href="https://docs.open.alipay.com/301/106168/">...</a>
     */
